...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu May 9 15:31:02 2013
# Project:  Thoth.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Thoth1.0.0/ && $(COPY_FILE) --parents Camera.h GLWidget.h Illumination.h Model.h ModelManager.h Point3D.h Render.h Render2D.h Scenary.h thotwindow.h Util.h RenderManager.h thothwindow.h CameraManager.h CameraOrtho.h CameraPerspective.h ProjectManager.h TreeFile.h RenderExplorer.h CameraFP.h .tmp/Thoth1.0.0/ && $(COPY_FILE) --parents Camera.cpp GLWidget.cpp Illumination.cpp main.cpp Model.cpp ModelManager.cpp Point3D.cpp Render.cpp Render2D.cpp Scenary.cpp thothwindow.cpp RenderManager.cpp CameraManager.cpp CameraOrtho.cpp CameraPerspective.cpp ProjectManager.cpp TreeFile.cpp RenderExplorer.cpp CameraFP.cpp .tmp/Thoth1.0.0/ && $(COPY_FILE) --parents thothwindow.ui .tmp/Thoth1.0.0/ && (cd `dirname .tmp/Thoth1.0.0` && $(TAR) Thoth1.0.0.tar Thoth1.0.0 && $(COMPRESS) Thoth1.0.0.tar) && $(MOVE) `dirname .tmp/Thoth1.0.0`/Thoth1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Thoth1.0.0
