...
void main()
{
  ...
  vec4 m1Color = texture2D(m1, texture_coord);
  vec4 m2Color = texture2D(m2, texture_coord);
  vec4 m3Color = texture2D(m3, texture_coord);
  vec4 m4Color = texture2D(m4, texture_coord);
